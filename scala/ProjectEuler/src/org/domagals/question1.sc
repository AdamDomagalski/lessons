...
object question1 {
  println("Welcome to the Scala worksheeeet")     //> Welcome to the Scala worksheeeet
  
  val lista = 1 to 999                            //> lista  : scala.collection.immutable.Range.Inclusive = Range(1, 2, 3, 4, 5, 6
  ...
  val suma = lista.filter(e => e%3==0 || e%5==0).foldLeft(0)(_+_)
                                                  //> suma  : Int = 233168
  println(suma)                                   //> 233168
